...
//
// Layout (40 bytes, all 4-byte aligned):
//   radius / thickness / ior / abbe_v / semi_aperture / coating /
//   is_stop / z / surface_type / radius_y
// The trailing two fields (M3) carry anamorphic geometry — surface_type
// from SurfaceType in lens.h, radius_y is the orthogonal toric radius.
struct GPUSurface
{
    float radius;
    float thickness;
    ...
    float radius_y;       // toric only; 0 for spherical / cylinder
};
