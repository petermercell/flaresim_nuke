// ============================================================================
// FlareSim3D.mm — 3D-aware lens flare simulation for Nuke (Metal backend)
...
public:
    ...
    void rebuild_surf_ui()
    {
        ...
        if (lens_.surfaces.empty()) {
            ...
            // Use Knob::visible(bool) — see comment in FlareSim.mm.
            for (int k = 0; k < MAX_SURFS_UI; ++k) {
    ...
    void do_compute()
    {
        ...
        if (cam_focal < 0.1f || cam_hap < 0.1f || cam_vap < 0.1f) {
            zero_buffers();
            pending_gpu_error_ = "FlareSim3D: invalid camera parameters "
